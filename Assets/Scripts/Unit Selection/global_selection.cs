    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonUp(0))
        {
            ...
            else //marquee select
            {
                ...
                for (i = 0; i < selectionMesh.vertices.Length-1; i++)
                {
                        Debug.DrawLine(Camera.main.ScreenToWorldPoint(selectionMesh.vertices[i]),
                                       Camera.main.ScreenToWorldPoint(selectionMesh.vertices[i + 1]),
                                       Color.yellow, 1.0f);                    
                }
